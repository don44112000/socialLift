...
<strong>For the  specific description of API endpoints and code examples of each step, please see [Shopping Ads](https://ads.tiktok.com/marketing_api/docs?id=1741942179356738&rid=6pdx02ym97f). </strong>
