...
> <span style="color: DodgerBlue">**Note**</span><br>If you are running a report at the ad level, you need to add `campaign_ids` as a filter. No more than 30 campaign IDs should be added. 
