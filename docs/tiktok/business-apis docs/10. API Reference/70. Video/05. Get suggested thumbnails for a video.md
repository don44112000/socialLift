...
|poster_number |number|Number of cover candidates you want to get. Range: `1-10`. Default value: `10` .</br>If the total number of  cover candidates is less than the number given, all candidates will be returned. |
```
