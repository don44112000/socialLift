...
Navigate to the [My organizations](https://developers.tiktok.com/organizations) page by selecting **My organizations** from the Developer menu: the user icon on the top right of the page. Here you can see all the organizations you are a member of. Click on an organization to view its details.
...
Follow the instructions described in [Register you app](/doc/getting-started-create-an-app). When prompted to select the app owner, choose one of your organizations from the list.
...
1. Navigate to your app from the [Manage apps](https://developers.tiktok.com/apps/) page.
1. Select an app which you own that you wish to import.
1. Open the advanced management drop-down by clicking the three dots (**...**). 
1. Click **Transfer App**.
1. Select the desired organization, and click **Initiate Transfer**.
...
Navigate to the [My organizations](https://developers.tiktok.com/organizations) page and click **Add organization**. Enter a name for your organization and click **Create**. Your organization will be created and you will be set as an administrator by default. 
...
1. Navigate to your organization from the [My organizations](https://developers.tiktok.com/organizations) page. 
1. Scroll down to the **Members** section.
1. Click **Add member**.
...
1. Choose the right role for the invitee.
...
1. Click the three dots (**...**) button to show additional actions, and select **Remove**.
...
1. Navigate to your organization from the [My organizations](https://developers.tiktok.com/organizations) page.
1. Click the menu button (three dots: **...**) and select **Give up admin rights**. 
1. Confirm that you want to give up admin rights.
