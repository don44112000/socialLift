...
1. Create or join an [organization](/doc/working-with-organizations) representing the owning group of the app. This step is highly recommended but not required.

## Connect your app 

Follow these steps to add your app to TikTok for Developers.
1. [Log in](https://developers.tiktok.com/login/) using your TikTok developer account.
1. Click the profile icon in the main navigation bar, then click **[Manage apps](https://developers.tiktok.com/apps)** to access a list of your apps. 

<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/97aeb730722c715f40e7f10201fee74b" alt="image" width="402.000000px" />
...
1. When prompted to **Select the app owner**, choose one of your organizations and click **Confirm**. If you don't see any [organizations](/doc/working-with-organizations), consider creating one. You may also register the app directly under your individual developer account, but this is not recommended for real app integrations.
1. [Fill in the information](#configure_settings_for_your_app) on the app page and add the desired products. 
1. Once your app configuration is complete, [submit your app for review](#submit_your_app_for_review).
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/30e4ec1a0f0bf5fd3dab0c3c589a85aa" alt="image" width="732.000000px" />
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/a7eacc2ad813616be3c09fd45641994c" alt="image" width="316.000000px" />
...
- Toggle between **Production** mode and **Sandbox **mode: 
  ...
  - **Sandbox** mode is a restricted environment that allows you to try out integrations without having to submit your app for review. Learn more about [Sandbox mode](/doc/add-a-sandbox).
...
- Click **App details**, **Products**, or **Scopes** to scroll the page to the corresponding section. 
  ...
  - In the **Scopes** section, you can add scopes to configure access to specific data or perform specific actions. Learn more about [scopes](/doc/). 
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/23830cda73f72d2f5eaee249228c709e" alt="image" width="266.000000px" />
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/a6f52b5243fe4150c241041cba503c4a" alt="image" width="272.000000px" />
...
Each product has its own specific settings. For example, examine the product-specific settings for [Login Kit](/doc/login-kit-overview).
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/3fce2de336142aa54a1a2f17fb562922" alt="image" width="296.000000px" />

1. Ensure you are verifying properties for your app in **Production** mode, then click **Verify properties**.
1. Choose whether to verify your URL by **Domain** or **URL prefix**:
  1. For verification by Domain, enter your domain and subdomain name, then click **Verify**. 
  1. For verification by URL prefix, enter your complete URL, then click **Verify**. Download the provided signature file, then upload it to your URL. 

## Submit your app for review

Before you integrate with our developer products, you must submit your app for review. Familiarize yourself with our [developer guidelines](/doc/our-guidelines-developer-guidelines) and [app review guidelines](/doc/app-review-guidelines) to understand our integration processes and requirements before submitting your changes for review.

Follow these steps to submit your app for review. 
1. Go to the **App review** section on your app page and complete the required information for app submission. 
  1. In detail, explain how each product and scope works within your app or website. For revisions, you must explain changes regarding the new configuration in this section. 
  1. Upload at least one demo video that shows the complete end-to-end flow of the integrations. You may upload a maximum of 5 videos, up to 50 MB each. 

1. Click the **Save **button to save your changes. 
1. Once you are satisfied with your app configuration, click the **Submit for review** button.
