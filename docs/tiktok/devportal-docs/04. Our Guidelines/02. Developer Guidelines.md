...
1. Make sure your app is functioning during our review process. You are required to provide demo accounts and capabilities to our approvers free of charge, if requested.
  1. For incomplete apps, beta or development versions, and test versions, you are encouraged to use [Sandbox mode](/doc/add-a-sandbox) to test out our integrations.

1. Follow our guidelines throughout the duration of your integration with TikTok. Any violations of our guidelines found through auditing, user complaints, or other means will likely lead to immediate revocation of your integration and a permanent ban on all future integrations by your account and business entity.
1. Verify ownership of all configurations with a URL, including your Privacy Policy, Terms of Service, and more. Learn more about [URL verification](/doc/getting-started-create-an-app#verify_url_ownership).
...
1. Never remove a creator's copyright mechanisms (such as watermarks) without consent.
1. Protect the user's identity and anonymity.
  1. If you have access to a user's PII (Personally Identifiable Information), never share it with anyone without their consent.

1. Follow all data sharing and privacy laws to build trust with users and governments.
1. Set an accurate description, title, and icon for your app.
1. Disclose your app's Terms of Service and Privacy Policy.
1. Verify URL ownership. 
1. Provide all required data when configuring your app integration and developer profile.
...
1. You must actively maintain communication with TikTok when requested. Failure to respond to correspondence in a timely manner can lead to termination of your integration.
  1. Check your email filters and make sure our communications are not landing in your spam or junk mail folders.
  1. Any sensitive communication relating to topics including but not limited to security, privacy, compliance, and user deception must be addressed immediately regarding these matters.

1. TikTok reserves the right to deprecate APIs and SDKs. You must prioritize and update your integration as new features are offered by TikTok for Developers.
1. You will be given notice when backward incompatible changes are made to our APIs. You must prevent any user interfaces from being broken because of deprecated integrations by promptly migrating to newer APIs.
1. For any security, privacy, and compliance related concerns, you must immediately acknowledge communication from TikTok and update your integration.
1. Respect our API throttling limits. It goes without saying, don't use your integration to attack us, our users, or anyone else with denial of service attempts, spam, etc. That's a surefire way to get banned forever and find yourself in more trouble than you or we need.
