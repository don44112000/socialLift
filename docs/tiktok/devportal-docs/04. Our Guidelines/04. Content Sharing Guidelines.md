...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/0a0d2b2d52bb33c76e7b356d4f142750" alt="image" width="4976.000000px" />
...
e. API clients should poll the [publish/status/fetch API](/doc/content-posting-api-reference-get-video-status) or handle status update webhooks, so users can understand the status of their posts.
