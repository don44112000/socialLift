...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/f983836a39b661f345814141826763c4" alt="image" width="2100.000000px" />

### Step 2: Install the SDK and set up the Android project

1. In the **Project** window, switch to the **Android view** tab.
1. Open **Gradle**** Scripts** and locate `build.gradle` (Project). 
1. Add the following repository in the `repositories{}` section:
...
1. Open** ****Gradle**** Scripts** and locate `build.gradle` (Module: app).
1. Add the following implementation statement to the `dependencies{}` section.
