...
Its value should always be set as `client_credentials`. |
### Response struct
...
The generated client access token. || 
...
The expiration for the `access_token` in seconds. **It**** is valid for 2 hours after the initial issuance**. || 
...
At the time of this writing, this guide is applicable to [Research API](/doc/research-api-get-started) and [Commercial Content API](/doc/commercial-content-api-getting-started).
