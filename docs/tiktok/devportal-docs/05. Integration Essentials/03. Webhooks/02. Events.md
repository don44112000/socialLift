...
Webhooks let you subscribe to events and receive notice when an event occurs. For more information about how to set up a webhook subscription, see [Webhooks Overview](/doc/webhooks-overview).
...
Fired when the video uploaded from [Video Kit](/doc/web-video-kit-with-web) fails to upload in TikTok.
#### Example payload
...
Fired when the video uploaded from [Video Kit](/doc/web-video-kit-with-web) has been published by the user in TikTok.
#### Example payload
