...
Learn more about [scopes](/doc/scopes-overview).
## Token security
...
**Preferred: **If you are using the new [Android](/doc/mobile-sdk-android-quickstart) or [iOS](/doc/mobile-sdk-ios-quickstart) TikTok OpenSDK, please refer to the new [user access token management guide](/doc/oauth-user-access-token-management).

**Legacy: **If you are using the old [Android](/doc/mobile-sdk-android-quickstart) or [iOS](/doc/mobile-sdk-ios-quickstart) TikTok OpenSDK, please refer to the [legacy user access token management guide](/doc/legacy-user-access-guide).
## Endpoints for desktop

You must register a redirect URI for your desktop app and use `https://www.tiktok.com/v2/auth/authorize/` to authorize. Please refer to the [new generation user access token management API guide](/doc/oauth-user-access-token-management) to manage the user access token.
