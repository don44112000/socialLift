...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/6488b2520fd74e5f2dce77c5aae9f9fc" alt="image" width="2534.000000px" />
...
1. Create a `ShareRequest` object and set the required parameters. You can use the `shareFormat` field in the share request object to share images or videos with TikTok in different formats.
  1. `Format.DEFAULT`: The default share format. This format allows your app to share images or videos, as is, with TikTok.
  1. `Format.GREEN_SCREEN`: See [Green Screen](https://developers.tiktok.com/doc/green-screen-kit) for more details.
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/3446607a62a44be1bfc2340e9d03d6b0" alt="image" width="1280.000000px" />
