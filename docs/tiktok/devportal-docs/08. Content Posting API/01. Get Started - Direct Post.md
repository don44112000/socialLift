...
**New: **Content Posting API now supports [posting photos](/doc/content-posting-api-reference-photo-post#)!
# Get Started
...
1. A valid video if you want to post videos:
  ...
  - Alternatively, you can provide the URL of a video from your verified domain or URL prefix. Learn how to [verify your domain or URL prefix](/doc/content-posting-api-media-transfer-guide#pull_from_url).
  - Learn more about [video restrictions](/doc/content-posting-api-media-transfer-guide#video_restrictions).

1. A valid photo if you want to post photos:
  - You must provide a URL of a photo from your verified domain or URL prefix. Learn how to [verify your domain or URL prefix](/doc/content-posting-api-media-transfer-guide#pull_from_url).
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/78cba97728b274ecdaeefa5e30c34946" alt="image" width="2154px" />

1. Get approval and authorization of the `video.publish` scope. Learn more about [scopes](/doc/scopes-overview).
  1. Your app must be approved for the `video.publish` scope.
  1. The target TikTok user must have authorized your app for the `video.publish` scope.
...
To initiate a direct post to a creator's account, you must first use the Query Creator Info endpoint to get the target creator's latest information. For more information about why creator information is necessary, refer to these [UX guidelines](/doc/content-sharing-guidelines#).
...
To initiate video upload on TikTok's server, you must invoke the [Direct Post Video](/doc/content-posting-api-reference-direct-post) endpoint. You have the following two options:
...
1. [Send the video ](/doc/content-posting-api-reference-direct-post#)from your local filesystem to the extracted `upload_url` using a PUT request. The video processing will occur asynchronously once the upload is complete.
