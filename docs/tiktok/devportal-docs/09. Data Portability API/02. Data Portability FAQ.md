...
1. **Why do I need to fill out the Data Portability API Application form?**
...
1. **How does the Data Portability API Application differ from App Review?**
...
1. **What languages do you support on the application?**

  Please submit your entire application in English, including the UX mockups and any other uploads. 
1. **Can I apply for the Data Portability API before I submit my app or website for review?**

  Yes, you can submit an application for the Data Portability API while your app is in Draft status.
1. **What if I cannot supply all the information being requested?**
...
1. **Will a TikTok representative contact me about my application?**
...
1. **What happens if I am not approved?**
...
1. **What should I do if I made a mistake or need to resubmit my application?**

  Please submit a [support ticket](https://developers.tiktok.com/support/) and select **Data Portability API** as the **Topic**.
1. **What happens after I go live with Data Portability API? **
...
1. **Can I get a copy of my application?**
