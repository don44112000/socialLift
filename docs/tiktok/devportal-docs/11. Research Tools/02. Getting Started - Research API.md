...
Once you have obtained the client key and secret for your project, [generate a client access token](/doc/client-access-token-management). Add this access token in the authorization header of the http requests to connect to the Research API endpoints.
...
The field name this condition is restricting || 
...
The comparison logic of this condition. One of: "EQ", "IN", "GT", "GTE", "LT", "LTE" || 
...
A list of values to be compared with || 
...
The max count of TikTok videos in response. default: 10, max: 100 || 
...
The starting index of TikTok videos in response. default: 0 || 
