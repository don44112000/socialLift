...
See Shop Info Object below for a full list of values.
...
shop_name as the unique identifier || 
...
Max data can be returned at one time (max 10 for TTS related data) || 
...
The returned shop info for shops operating in the EU.
...
The rating of the shop || 

"shop_review_count" || 

int64 || 

The number of reviews the shop has received || 

"item_sold_count" || 

int64 || 

The number of items the shop has sold || 

"shop_performance_value" || 

int64 || 

The value of shop performance (Ex: 90) |
## Example
