...
NOTE: "username" is the only query able parameter. "EQ" is the only operator.
...
id, create_time, username, region_code, video_description, music_id, like_count, comment_count, share_count, view_count, hashtag_names, is_stem_verified, favorites_count, hashtag_info_list, effect_info_list, sticker_info_list, video_label, video_mention_list, video_tag
...
Whether the request was successfully cancelled
...
id, create_time, username, region_code, video_description, music_id, like_count, comment_count, share_count, view_count, hashtag_names, is_stem_verified, favorites_count, hashtag_info_list, effect_info_list, sticker_info_list, video_label, video_mention_list, video_tag, video_duration
