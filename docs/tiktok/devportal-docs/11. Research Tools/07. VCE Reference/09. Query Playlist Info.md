...
NOTE: "playlist_id" is the only query able parameter. "EQ" is the only operator.
...
playlist_id, playlist_name, playlist_video_ids, playlist_last_updated, and playlist_item_total
