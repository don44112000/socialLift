...
The data can be: product_name, product_id, shop_name
...
Data fields returned from the query. Interface will only return the fields listed here foe reviews given for products sold in the EU. || 
