...
The time range when the ads were published.
...
The country where the ads/ad groups were created. The default value is ALL.

[Supported Countries](/doc/commercial-content-api-supported-countries) || 
...
The advertiser's business ID of the ads/ad groups. || 

[21836478203048,3484763562784] || 
...
map<string,list<DateCount>> || 

The ad count time series of each country. ||  |
### DateCount
...
The date when ads were published in the format YYYYMMDD. || 
...
The total number of ads published on that date. || 
