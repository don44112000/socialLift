...
1. **Feature enablement**: Enable monetization features by accepting payment terms, then integrate with monetization APIs to configure these features in your mini app. 
1. **Payout setup**: After enabling at least one monetization feature, provide business, tax, and bank information to set up a payout account. Any earnings will remain in your balance until you finish setting up.
...
1. Go to your organization's **Monetization** page.
1. Go to the **Feature enablement** section on the **Overview** page.
1. Click the **Enable** button for whichever feature your business scenario requires. The following features are available: 
  - Mini games
...
1. Review and sign the terms and agreements for your specified monetization feature. You can connect with monetization APIs for your mini game and mini drama after this step. 
...
- [In-App Ads setup](/doc/in-app-ads)
- [In-App Purchases setup](/doc/in-app-purchases)
...
- **Foreign tax identification number**: The tax identification number for your business in the country of registration.
- **Permanent address**: The permanent address of the beneficiary or owner of the business.
 || 
- **Business entity name**
- **Country of registration **
- **Backup withholding status**
- **U.S. Employer Identification Number (EIN)**
- **Federal tax classification type**
  - C corporation 
  - S corporation 
  - Partnership
  - Trust/estate
...
- **Foreign owners or beneficiaries **
- **Permanent address**: The permanent address of the beneficiary or owner. This will be used for your company's W-9 tax form.
