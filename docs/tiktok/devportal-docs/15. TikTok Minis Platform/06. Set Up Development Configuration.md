...
1. Click the **Security** tab on your **Development configuration** page. 
1. Click the **Add domain** button to enter a URL. 
...
1. Click the **Webhooks** tab on your **Development configuration** page. 
1. Enter a callback URL. TikTok will push messages to this URL when a specified event occurs. 
1. Click the **Test URL** button to send a test event. We'll send a POST request to your callback URL when you click the **Send** button.
1. Once you've verified that your application received the request correctly, click the **Save changes** button. 

Learn more about [webhooks](/doc/webhooks-overview). 
...
1. Click the **Webhooks** tab on your **Development configuration** page. 
1. Click the **Verify properties **button.
