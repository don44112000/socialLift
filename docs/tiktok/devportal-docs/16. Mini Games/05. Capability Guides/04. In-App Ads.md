...
- [Enabled in-app ads](/doc/enable-monetization-features) for your mini game
...
1. Call the In-App Ads API from the Mini Games SDK to create an ad instance. This instance provides methods for displaying and managing the ad. 
...
1. Display the ad in the corresponding scene of the game and distribute rewards upon completion. 
...
To set up interstitial ads for your mini games, follow the same process as above, using the [interstitial ad JavaScript APIs instead](/doc/mini-games-sdk-iaa#).
