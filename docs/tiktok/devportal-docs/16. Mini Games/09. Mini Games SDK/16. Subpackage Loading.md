...
Subpackage loading success callback event || 
...
Callback event for subpackage loading failure || 
...
Callback event for the end of subpackage loading (executed upon both successful and failed loading) || 
...
Subpackage download progress percentage || 

totalBytesWritten || 

number || 

Length of the data already downloaded, unit: Bytes || 

totalBytesExpectedToWrite || 

number || 

Expected total length of data to be downloaded, in Bytes |
...
Length of the data already downloaded, in bytes || 
