...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/6d4a59fbf3a2ac2d88e2c55a3f3bb649" alt="image" width="3100px" />
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/cad7f664144b27118e1a4fa2d18176de" alt="image" width="3370px" />
...
1. Review the [monetization overview and process](/doc/monetization-overview) for mini apps. 
...
1. After approval, configure monetization features for your mini app on the Developer Portal.
  1. IAAs: Create and configure your ad units to get unique identifiers for rewarded ads, interstitial ads, and other supported formats.
  1. IAPs: Configure your [payment callback URL for webhooks](https://developers.tiktok.com/doc/set-up-development-configuration#set_up_webhooks) to receive transaction updates from TikTok's servers.
...
`TTMinis.createInterstitialAd` || 

Insert interstitial ads into your mini app; IAA must be enabled to configure || 

Yes || 

In-App Purchases: Beans (one-time payment)
...
Allow one-time purchases with Beans to be made within your mini app; IAP must be enabled to configure
...
`TTMinis.createSubscription` || 

Allow subscriptions to be purchased within your mini app; IAP must be enabled to configure
...
- [Silent Login implementation guide](/doc/tiktok-minis-silent-login)
  - [Silent Login JavaScript API reference](/doc/minis-sdk-login#)
  - [Server API OAuth reference](/doc/minis-oauth)
...
- [Explicit Authorization implementation guide](/doc/tiktok-minis-explicit-authorization)
  - [Explicit Authorization](/doc/minis-sdk-login#)[ JavaScript API reference](/doc/minis-sdk-login#)
  - [OAuth Server API reference](/doc/minis-oauth)
...
- [In-App Ads configuration guide](/doc/tiktok-minis-in-app-ads)
  - [In-App Ads](/doc/minis-sdk-in-app-ads)[ JavaScript API reference](/doc/minis-sdk-in-app-ads)
...
- [In-App Purchases configuration guide](/doc/tiktok-minis-in-app-purchases)
  - [In-App Purchases](/doc/minis-sdk-payment)[ JavaScript API reference](/doc/minis-sdk-payment)
  - [Subscriptions JavaScript API reference](/doc/minis-sdk-subscriptions)
  - [Payment Server API reference](/doc/minis-payment-apis)
  - [Subscriptions Server API reference](/doc/minis-subscription-apis)

#### Navigation Bar

Configure a navigation bar in your mini app that adapts to the user's device. 
- [Navigation Bar configuration guide](/doc/tiktok-minis-navigation-bar)
  - [UI ](/doc/minis-sdk-ui)[JavaScript API reference](/doc/minis-sdk-ui)
