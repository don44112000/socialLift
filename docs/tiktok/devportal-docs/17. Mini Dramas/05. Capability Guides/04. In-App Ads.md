...
- [Enabled in-app ads](/doc/enable-monetization-features) for your mini app
...
1. Activate the ad slot immediately after creation
1. Use a new ad instance for each display 
1. Awards are only given when ` isEnded === true ` 
1. When strict risk control is required, developers can record reward distribution logs on the backend 
...
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/d47249f47743242eff9a7d99ea497237" alt="image" width="1280px" />

1. Go to your app's **Monetization** page under the **Operation** tab.
1. Go to the **In-App Ads (IAAs)** tab, then click the **Ad placements** toggle.
1. Click the **Add ad placement **button. 

<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/a668e0849990fca5f03f5a4813665ff8" alt="image" width="1280px" />

1. Enter the name of your ad, select the ad type, then click the **Add** button. 
  - Rewarded ad 
  - Interstitial ad

1. Switch the ad's status toggle to **Active**. 

**Note**: Ad placements are inactive by default and must be switched to **Active** to be used. 
1. Obtain the **Placement ID **of the ad you want to introduce as an incentive ad. 

<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/0fe4d9ef43462bab687056caedf0447a" alt="image" width="1280px" />

### Step 1: Your frontend creates an incentive ad instance 

To introduce the ad into your app's code, do the following: 
1. Call the In-App Ads API from the TikTok Minis SDK to create an ad instance. This instance provides methods for displaying and managing the ad. 
...
See the full list of [JavaScript APIs for IAA](/doc/mini-games-sdk-iaa).
...
1. First, confirm that the ad slot has been created and activated 
1. Start `minis dev`
1. Use the developer options in the debug page to enable ad mock 
1. Connect to the TikTok app by scanning the QR code 
1. Trigger ad display on the business page 
1. Verify separately:
  - Full playback
  - Closed midway
