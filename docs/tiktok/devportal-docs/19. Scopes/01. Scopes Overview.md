...
1. Click the **Add Scopes **button, then add your desired scopes. 
...
See how to [manage user access tokens](/doc/login-kit-manage-user-access-tokens) for `access_token` related endpoints.
<img src="https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/bc614e2c5de500ca36eaaf187ee3a8f3" alt="image" width="656.000000px" />

## Scopes Reference

You can find the list of available scopes and their explanation on [the scopes reference page](/doc/tiktok-api-scopes).
