...
There is a new version of this API available in TikTok API v2: [List Videos](/doc/tiktok-api-v2-video-list)
## Overview
...
act.example12345Example12345Example || 
...
The set of optional video fields

**Choose fields from: VideoObject's fields** || 
...
*Note: due our trust and safety policies, it is possible that the endpoint returns less than max_count number of videos even if **response.data.has_more** is **true**.* || 
...
Number of likes of the video. Included when requested in the fields. || 
...
Number of comments of the video. Included when requested in the fields. || 
...
Number of shares of the video. Included when requested in the fields. || 
...
Number of views of the video. Included when requested in the fields. || 
