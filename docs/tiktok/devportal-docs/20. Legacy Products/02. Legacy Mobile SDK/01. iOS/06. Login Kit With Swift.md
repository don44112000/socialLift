...
Obtain a client key and client secret by logging in to [Developer Portal](https://developers.tiktok.com/apps/) and selecting your app. Refer to the [Quickstart Guide](/doc/getting-started-ios-quickstart-swift) for detailed steps.
### iOS Integration
